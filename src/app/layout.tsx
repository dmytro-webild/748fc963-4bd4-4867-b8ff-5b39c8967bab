...
export const metadata: Metadata = {
  title: "Blackheart Cafe | Best Cafe in Gaya for Food & Hangouts",
  description: "Blackheart Cafe is the most popular cafe in Gaya. Enjoy delicious food, stylish ambience, birthday celebrations, and the perfect hangout spot for friends and couples.",
  keywords: "best cafe in gaya, restaurant in gaya, hangout cafe gaya, birthday celebration cafe, cafe near me gaya",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Blackheart Cafe | Best Cafe in Gaya",
    description: "The most loved cafe in Gaya. Amazing food, cozy ambience, and perfect vibes for hangouts and celebrations.",
    siteName: "Blackheart Cafe",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/enjoying-cup-coffee_1098-17179.jpg",
        alt: "Blackheart Cafe stylish interior",
      },
    ],
  },
  twitter: {
    ...
    title: "Blackheart Cafe | Best Cafe in Gaya",
    description: "Experience amazing food and vibes at Gaya's most popular cafe.",
    images: ["http://img.b2bpic.net/free-photo/enjoying-cup-coffee_1098-17179.jpg"],
  },
};
